...
const String PHONE = " ";                                       //Enter your phone no. which will recieve SMS on your phone.
//--------------------------------------------------------------
...
//--------------------------------------------------------------
float initialLatitude = ;                                       //Enter the Latitudes of the vicinity area
float initialLongitude = ;                                      //Enter the Longitudes of the vicinity area
